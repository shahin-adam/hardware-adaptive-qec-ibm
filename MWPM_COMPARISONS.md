...
This register includes only comparisons explicitly identified as MWPM/PyMatching in authoritative project records and evaluated on a matched block. Improvement is `MWPM LER - candidate LER`, in percentage points: positive favors the candidate; negative favors MWPM. Values measured against CNN, Transformer, V12, raw readout, or another candidate are not silently relabeled as MWPM comparisons.
...
| V501 | Default DEM-based PyMatching/MWPM | Corrected-observable offline replay, 1,536 preserved real-IBM detector-event shots | 49.934896% | 50.390625% raw/no-correction comparator | +0.455729 pp | Accuracy null | V501 independent PyMatching decision; paired-bootstrap 95% CI [-2.929688, +3.906250] pp. Here MWPM is the candidate decoder and raw LER is its comparator. |
...
- Matched or explicitly labeled MWPM comparisons: 5 versions.
