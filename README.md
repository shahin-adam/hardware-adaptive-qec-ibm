...
contains an explicit row for every version from V1 through V204, including
...
| V190 | Best pooled +0.41245 pp; X +0.82491 pp, Z 0.00000 pp | Completed moment-alignment ablation; alignment reduced gain and no arm safely activated Z; rejected |
...
| V204 | +0.78482 pp over the external benchmark baseline; calibration adapter added +0.01512 pp | Completed three-backend repetition-code development; positive X/Z and adapter increment, not V12-comparable |
